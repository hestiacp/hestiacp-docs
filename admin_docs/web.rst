...
.. list-table:: Variables
   ...
   * - %proxy_extentions%
     - List of extensions
     - Extensions that should be handled by the proxy server
...
Due to the fact we use multi PHP we need to recognise the PHP version to be used.
Therefore we follow the following naming:
