...
**Example of usage:** *bash hst-install.sh -n yes -w yes -t no -c no -x yes -z yes -b no -i yes -m yes -l de -s youdomain.tld -e yourmail@mail.com -p yourpasswordhere -a no -k no -o no*
